function [output] = TTECTrA_controller_setup(inputs)
%       TTECTrA.m
%**************************************************************************
...
S.fh = figure('units','pixels',...
    'position',[100 100 610 430],...
    'menubar','none',...
    'name','Tool for Turbine Engine Closed-loop Transient Analysis Setup',...
    'numbertitle','off',...
    'visible','off',...
    'resize','off');

%------ Linear Model Panel ------
S.lmpanel = uipanel('units','pix',...
    'pos',[10 230 600 190],...
    'fontsize',12,...
...
S.lmtx(1) = uicontrol(S.lmpanel,...
    'style','text',...
    'unit','pix',...
    'position',[240 90 160 40], ...%[240 55 160 40],...
    'HorizontalAlignment','center',...
    'fontsize',9, ...
...
S.lmvarinput = uicontrol(S.lmpanel,...
    'style','edit',...
    'unit','pix',...
    'position',[440 105 120 30], ...%[440 70 120 30],...
...
S.lmtx(2) = uicontrol(S.lmpanel,...
    'style','text',...
    'unit','pix',...
    'position',[240 15 160 40], ...%[240 5 160 40],...
    'HorizontalAlignment','center',...
    'fontsize',9, ...
    'String','# Output of LM');
...
S.outinput = uicontrol(S.lmpanel,...
    'style','edit',...
    'unit','pix',...
    'position',[440 30 120 30], ...%[440 20 120 30],...
    'HorizontalAlignment','left',...
    'fontsize',10,...
    'backgroundcolor','white');

%------ Controller Tuning Defaults Panel ------
S.defaultpanel = uipanel('units','pix',...
    'pos',[10 10 600 210],...
    'fontsize',12,...
    'TitlePosition', 'centertop',...
...
%--------------------------------
    function varargout = lmsetup_call(varargin)
        ...
        %----------------------------------------------------
        FileName=uigetfile('*.mat','Linear Model File');
