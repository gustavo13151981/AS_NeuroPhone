...
public class RelojAlarmaActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_relojalarma);
    ...
    public void RecibirMensaje(String texto) {
        ...
        //############################# DEBUG #############################\\
        Utility.PrintDebug("RelojAlarmaActivity","Mensaje Recibido = " + texto, null);
